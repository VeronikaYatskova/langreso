...
import { GraphData } from '@widgets/dependecies/graph'
import { WordsGraphWidget, WordsInstrumentsWidget } from '@widgets/words'
import { useEffect, useState } from 'react'

import styles from './WordDependencies.module.scss'

export const WordDependenciesPage = () => {
	...
	return (
		<>
			<div className={styles.settingsPanel}>
				<WordsInstrumentsWidget />
			</div>
			<div className={styles.graphSandbox}>
				<WordsGraphWidget height={800} width={1600} data={graphData} />
			</div>
		</>
	)
}
