...
(function (global, factory) {
  ...
  var omit = function omit(obj, keys) {
    ...
    return Object.assign.apply(Object, [{}].concat(_toConsumableArray$4(Object.entries(obj).filter(function (_ref2) {
      var _ref3 = _slicedToArray$4(_ref2, 1),
        key = _ref3[0];
  ...
  var fromEntries = /*@__PURE__*/getDefaultExportFromCjs(fromentries);
  ...
  function index$4 (kapsuleComponent, comboParam) {
    var _ref = _typeof$2(comboParam) === 'object' ? comboParam : {
    ...
    return /*#__PURE__*/React.forwardRef(function (props, ref) {
      ...
      var dynamicProps = omit(props, [].concat(_toConsumableArray$3(methodNames), _toConsumableArray$3(initPropNames))); // initPropNames or methodNames should not be called
      ...
      keys.forEach(function (_ref, idx) {
        ...
        if (isProp) {
          var _itemVal = itemVal,
            ...
            rest = _objectWithoutProperties(_itemVal, [keyAccessor].map(_toPropertyKey$1));
          key = propVal;
          itemVal = rest;
        } else {
